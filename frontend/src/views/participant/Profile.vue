      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <Card v-for="myReg in myRegistrations" :key="myReg.registration_id"
              ...
              <CardContent>
                ...
                <div class="flex justify-between items-center mt-4">
                  ...
                  <Button variant="outline" size="sm" class="hover:bg-purple-50 hover:border-purple-300 cursor-pointer"
                    @click="goToEventDetail(myReg.event_id)">View Details</Button>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <div v-if="activeTab === 'events'" class="space-y-6">
          ...
          <div v-else-if="myEvents.length === 0" class="text-center py-12">
            ...
            <Button class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition cursor-pointer"
              @click="goToManageEvents">
              ...
              <div class="relative">
                ...
                <CardContent class="p-6">
                  <div class="space-y-4">
                    <div>
                      <h3
                        class="text-xl font-bold text-gray-900 group-hover:text-purple-600 transition-colors line-clamp-2">
                        {{ event.title }}
                      </h3>
